    ...
    <div class="max-w-4xl bg-white rounded-xl shadow-md p-6 border border-gray-200">
        ...
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Thuộc danh mục <span
                            class="text-red-500">*</span></label>
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Số lượng tồn kho <span
                            class="text-red-500">*</span></label>
            ...
            <div class="flex items-center gap-2">
                ...
                <label for="is_active" class="text-sm font-semibold text-gray-700 cursor-pointer">Bật hiển thị sản phẩm ngay
                    sau khi tạo</label>
            </div>
