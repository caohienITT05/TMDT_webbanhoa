...
<img
    src="{{ asset('images/Home/tiemhoa1.png') }}"
    alt="Banner cửa hàng hoa"
    style="
        width: 100%;
        height: 100%;
        display: block;
...
<section class="section services-section">
    ...
    <div class="services">
        ...
        <div class="service-card">
            <img
                src="{{ asset('images/Home/giao-hang.jpg') }}"
                alt="Giao hàng đúng hẹn"
                class="service-image"
            >
        ...
        <div class="service-card">
            <img
                src="{{ asset('images/Home/hoa-tuoi.jpg') }}"
        ...
        <div class="service-card">
            <img
                src="{{ asset('images/Home/goi-qua.jpg') }}"
                alt="Gói quà theo yêu cầu"
                class="service-image"
            >
        ...
        <div class="service-card">
            <img
                src="{{ asset('images/Home/thiep-loi-chuc.jpg') }}"
                alt="Thiệp và lời chúc"
                class="service-image"
            >
    ...
    <div class="product-grid">
        ...
        <div class="product-card">
            <div class="product-image">
                <img src="{{ asset('images/Home/hoa-hong-do.jpg') }}"
                     alt="Bó Hoa Hồng Đỏ Tình Yêu">
            </div>
...
<a href="{{ route('products') }}" class="product-button">
    Xem sản phẩm
        ...
        <div class="product-card">
            <div class="product-image">
                <img src="{{ asset('images/Home/hoa-tulip-pastel.jpg') }}"
                     alt="Bó Hoa Tulip Pastel">
            </div>
...
<a href="{{ route('products') }}" class="product-button">
    Xem sản phẩm
        ...
        <div class="product-card">
            <div class="product-image">
                <img src="{{ asset('images/Home/gio-hoa-khai-truong.jpg') }}"
                     alt="Giỏ Hoa Khai Trương">
            </div>
...
<a href="{{ route('products') }}" class="product-button">
    Xem sản phẩm
        ...
        <div class="product-card">
            <div class="product-image">
                <img src="{{ asset('images/Home/hoa-cuc-hoa-mi.jpg') }}"
                     alt="Bó Hoa Cúc Họa Mi">
            </div>
...
<section class="section custom-order-section">
    <div class="custom-order-container">
        ...
        <div class="custom-order-image">
            <img src="{{ asset('images/Home/dat-hoa-theo-mong-muon.jpg') }}"
    ...
    <div class="process-grid">
        ...
        <div class="process-card">
            <div class="process-image">
                <img src="{{ asset('images/Home/chon-hoa.jpg') }}"
                     alt="Chọn mẫu hoa">
            </div>
        ...
        <div class="process-card">
            <div class="process-image">
                <img src="{{ asset('images/Home/tu-van-hoa.jpg') }}"
                     alt="Tư vấn và thiết kế hoa">
            </div>
        ...
        <div class="process-card">
            <div class="process-image">
                <img src="{{ asset('images/Home/xac-nhan-don.jpg') }}"
        ...
        <div class="process-card">
            <div class="process-image">
                <img src="{{ asset('images/Home/giao-hoa.jpg') }}"
...
<style>
    ...
    <footer>
        <div class="footer-content">
            ...
            <div>
                ...
                <p>
                    Mang đến những món quà ý nghĩa cho mọi khoảnh khắc.
                </p>
            </div>
    ...
    <a href="#categories">Danh mục hoa</a>
    ...
    <a href="#cart">Giỏ hàng</a>
            ...
            <div>
                <h3>Thông tin BloomGift</h3>

                <p>📍 Việt Nam</p>
                <p>📞 0368323069</p>
                <p>✉️ bloomgift@gmail.com</p>
                <p>🌸 Hoa tươi - Quà tặng - Yêu thương</p>
            </div>
